...
AVANZAR:
BSF PORTD,1 ;SALIDA AVANZAR MOTOR IZQUIERDO
BSF PORTD,2 ;SALIDA AVANZAR MOTOR DERECHO
BCF PORTD,3 ;SALIDA RETROCEDER MOTOR IZQUIERDO
BCF PORTD,4 ;SALIDA RETROCEDER MOTOR DERECHO
BCF PORTD,5 ;SALIDA LED DERECHO
BCF PORTD,6 ;SALIDA LED STOP
BCF PORTD,7 ;SALIDA LED IZQUIERDO
GOTO MAIN

DETENER:
BCF PORTD,1 ;SALIDA AVANZAR MOTOR IZQUIERDO
BCF PORTD,2 ;SALIDA AVANZAR MOTOR DERECHO
BCF PORTD,3 ;SALIDA RETROCEDER MOTOR IZQUIERDO
BCF PORTD,4 ;SALIDA RETROCEDER MOTOR DERECHO
BCF PORTD,5 ;SALIDA LED DERECHO
BSF PORTD,6 ;SALIDA LED STOP
BCF PORTD,7 ;SALIDA LED IZQUIERDO
GOTO MAIN
...
BCF PORTD,3 ;SALIDA RETROCEDER MOTOR IZQUIERDO
BCF PORTD,4 ;SALIDA RETROCEDER MOTOR DERECHO
BSF PORTD,5 ;SALIDA LED DERECHO
BCF PORTD,6 ;SALIDA LED STOP
BCF PORTD,7 ;SALIDA LED IZQUIERDO
GOTO MAIN
...
BCF PORTD,5 ;SALIDA LED DERECHO
BCF PORTD,6 ;SALIDA LED STOP
BSF PORTD,7 ;SALIDA LED IZQUIERDO
GOTO MAIN
...
INISYS:
    ...
    BSF TRISC, 1 ;PORT (C1) PORTC,1 ;ENTRADA S0 (IZQUIERDO) ENTRADA
    BSF TRISC, 2 ;PORT (C2) PORTC,3 ;ENTRADA S2 (DERECHO) ENTRADA
    BSF TRISC, 3 ;PORT (C3) PORTC,2 ;ENTRADA S1 (CENTRAL) ENTRADA

    BCF TRISD, 1 ;PORT (D0) PORTD,1 ;SALIDA AVANZAR MOTOR IZQUIERDO SALIDA
    BCF TRISD, 2 ;PORT (D1) PORTD,2 ;SALIDA AVANZAR MOTOR DERECHO SALIDA
    BCF TRISD, 3 ;PORT (D2) PORTD,3 ;SALIDA RETROCEDER MOTOR IZQUIERDO SALIDA
    BCF TRISD, 4 ;PORT (D3) ((EECON1) and 07Fh), 0 SALIDA
    BCF TRISD, 5 ;PORT (D4) PORTD,5 ;SALIDA LED DERECHO SALIDA
    BCF TRISD, 6 ;PORT (D5) PORTD,6 ;SALIDA LED STOP SALIDA
    BCF TRISD, 7 ;PORT (D6) PORTD,7 ;SALIDA LED IZQUIERDO SALIDA
...
;
    ...
    MAIN:
    BTFSS PORTC,1 ;ENTRADA S0 (IZQUIERDO)
    GOTO STEP_1
    GOTO STEP_2

    STEP_1:
    BTFSS PORTC,3 ;ENTRADA S2 (DERECHO)
    GOTO STEP_3
    GOTO STEP_4
    ...
    STEP_3:
    BTFSS PORTC,2 ;ENTRADA S1 (CENTRAL)
    CALL DETENER
    CALL DERECHA
